...
class CustomCollectionViewCell: UICollectionViewCell {
    ...
    private func configConstraints() {
        NSLayoutConstraint.activate([
            self.imageHeart.trailingAnchor.constraint(equalTo: self.trailingAnchor,constant: -240),
            self.imageHeart.leadingAnchor.constraint(equalTo: self.leadingAnchor,constant: 50),
